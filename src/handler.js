...
export const login = async (event, context, callback) => {
  ...
  const body = await loginFunction(client, user, callback);
...
export const sendStayOut = async (event, context, callback) => {
  ...
  const body = await sendStayOutFunction(client, date_list, is_weekend, outStayAplyDt, callback);
...
export const findStayOutList = async (event, context, callback) => {
  ...
  const body = await findStayOutListFunction(client, yy, tmGbn, userNm, callback);
...
export const findPointList = async (event, context, callback) => {
  ...
  const body = await findPointListFunction(client, userNm, callback);
